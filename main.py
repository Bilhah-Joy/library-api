...
# Force SQLModel to recognize both models before table creation
from sqlmodel import SQLModel
SQLModel.metadata.create_all(engine)

app = FastAPI(
    title="Library API",
    description="A simple library management API with Categories and Search",
    version="1.0.0"
)
...
def update_book(
    ...
    # Extract only the data fields sent by the user
